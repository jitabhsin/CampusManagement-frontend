// C:\Users\ASUS\Documents\Infosysproject2025\campus-frontVite-main\src\Components\ItemComponent\LostItemSubmit.jsx
...
const LostItemSubmit = () => {
  ...
  const submitForm = () => {
    ...
    lostItemSubmission({
      ...
      .then(() => {
        alert("Lost Item submitted successfully! ID: " + newId);
        navigate("/StudentMenu");
      })
      .catch(() => alert("Failed to submit lost item."))
  ...
  const handleValidation = (e) => {
    ...
    if (ldate && edate && new Date(ldate) > new Date(edate)) {
      tempErrors.lostDate = "Lost Date cannot be after Entry Date";
      tempErrors.entryDate = "Entry Date cannot be before Lost Date";
      isValid = false;
    }
